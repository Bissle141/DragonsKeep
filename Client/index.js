...
const createSingleView = (character) => {
    ...
    container.setAttribute('id', "full-screen-containter")
...
const opencharacterCreator = () => {
    ...
    <div id="full-screen-containter">
        ...
        <div class="CC-right-div">
            ...
            <div id="char-creator-gender-race-display" ></div>
            <div id="char-creator-role-display"></div>
        </div>
    </div>
    `
...
const updater = (event) => {
    ...
    if(selectedGender != null && selectedRace != null) {
        ...
        if (selectedRace === "dwarf") {
            if(selectedRole  == null) {
                roleDisplay.style = 'background: url(./Portraits/Dragon.png) no-repeat transparent;background-position-x: center;background-size: contain;position: absolute;top: 45%;right: 15%;height: 360px;width: 180px;'
            }
        }
    ...
    if (document.getElementById('mage').disabled === true && event.target.value === "dwarf") {
